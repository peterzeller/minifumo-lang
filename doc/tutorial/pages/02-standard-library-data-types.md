...
Minifumo includes several foundational types in the standard library that appear in almost every program:

- `Nat` for natural numbers (`Zero`, `Suc(...)`),
- `Int` for signed integers,
- `Bool` for boolean values (`True`, `False`),
- `List[T]` for linked lists.
