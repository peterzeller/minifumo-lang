...
object TypedAst:
  ...
  final case class DatatypeSymbol(global: GlobalSymbol, tpe: Expr, file: Path) extends Symbol:
    def name: String = global.name

  final case class FunctionSymbol(global: GlobalSymbol, tpe: Expr) extends Symbol:
    def name: String = global.name

  final case class CtorSymbol(global: GlobalSymbol, tpe: Expr) extends Symbol:
    def name: String = global.name
